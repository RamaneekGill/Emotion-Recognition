...
def generateLabels(labels, num_classes):
...
def read_data_sets():
	...
	train_labels = generateLabels(train_labels, NUM_CLASSES)
	validation_labels = generateLabels(validation_labels, NUM_CLASSES)
